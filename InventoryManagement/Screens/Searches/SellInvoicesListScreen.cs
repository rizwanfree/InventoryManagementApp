...
{
    public partial class SellInvoicesListScreen : SearchTemplate
    {
        ...
        public SellInvoicesListScreen()
        {
            InitializeComponent();
        }

        private void SellInvoicesListScreen_Load(object sender, EventArgs e)
        {
            lblTitle.Text = title;
        ...
        public override void btnSearchDate_Click(object sender, EventArgs e)
        {
            ...
            MainClass.LoadDataToDataGrid(dgvList, _sell.GetByDate(fromDate, toDate));
        ...
        public override void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            MainClass.LoadDataToDataGrid(dgvList, _sell.GetByName(name));
            AddButtonColumn();
        }
    }
}
